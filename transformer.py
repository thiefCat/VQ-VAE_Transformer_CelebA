...
def build_config_from_args(is_jupyter=False):
    ...
    parser.add_argument('--num_layers', type=int, default=5, help="number of stacked transformer blocks")
    parser.add_argument('--num_embeddings', type=int, default=128, help="length of the codebook (embedding)")
    parser.add_argument('--num_heads', type=int, default=12, help="number of heads in attention layer")
    ...
    parser.add_argument('--out_dir', type=str, default="VQ-VAE-L/results", help="Directory of output logging")
...
if __name__ == '__main__':
    ...
    print(device)
    train_loader, test_loader = load_dataset(train_batch_size=128)  # the training data is in range [-1, 1]
    in_dim = 3
    size = 64
